...
export const MAIN_MENU: SidebarItem[] = [
    {
        ...
        path: '/admin/work_area/dashboard',
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                path: '/admin/work_area/delivery-manager/dashboard',
    ...
    },
    {
        title: 'Visitor Log',
        icon: ClipboardList,
        path: '/admin/work_area/visitor-log',
    ...
    // { title: 'Prefill Log', icon: ClipboardList, path: '/admin/work_area/prefill-log' },
    {
        title: 'Employee Log',
        icon: UserCheck,
        path: '/admin/work_area/employee-log',
    ...
    },
    {
        ...
        icon: UserPlus,
        path: '/admin/work_area/pre-registration',
    ...
    },
    {
        ...
        children: [
            { title: 'Delivery Log', path: '/admin/work_area/delivery-manager/delivery-logs', testid: 'delivery-log-link' },
            { title: 'Receiving Log', path: '/admin/work_area/delivery-manager/receiving-logs', testid: 'receiving-log-link' },
            { title: 'Delivery Areas', path: '/admin/work_area/delivery-manager/delivery-area', testid: 'delivery-areas-link' }
        ]
    },
    {
        title: 'Delivery',
        icon: Truck,
        path: '/admin/work_area/delivery',
        condition: (ctx) => !ctx.isDeliveryManagerEntitled,
        testid: 'nav-delivery'
    },
    {
        title: 'Locations',
        icon: Building2,
        path: '/admin/work_area/locations/list',
    ...
    },
    {
        ...
        children: [
            { title: 'Users/Employees', path: '/admin/work_area/users/users-list', testid: 'users-employees-link' },
            {
                title: 'User Groups',
                path: '/admin/work_area/users/users-groups',
                condition: (ctx) => ctx.isUserGroupEntitled,
                testid: 'user-groups-link'
            },
            { title: 'Administrators', path: '/admin/work_area/users/administrators', testid: 'administrators-link' },
            { title: 'User Delegate', path: '/admin/work_area/users/user-delegate', testid: 'user-delegate-link' }
        ]
    },
    {
        title: 'Analytics',
        icon: BarChart2,
        path: '/admin/work_area/analytics',
    ...
    },
    {
        ...
        children: [
            { title: 'Notification', path: '/admin/work_area/integration/notifications', testid: 'integration-notification-link' },
            { title: 'Guest WiFi', path: '/admin/work_area/integration/guest-wifi', testid: 'integration-guest-wifi-link' },
            { title: 'Employee/Staff Directory', path: '/admin/work_area/integration/employee-staff-directory', testid: 'integration-employee-directory-link' },
            { title: 'Single Sign On', path: '/admin/work_area/integration/single-sign-on', testid: 'integration-sso-link' },
            { title: 'Webhooks', path: '/admin/work_area/integration/webhook', testid: 'integration-webhooks-link' }
        ]
    },
    {
        title: 'Settings',
        ...
        children: [
            { title: 'General', path: '/admin/work_area/settings/general', testid: 'settings-general-link' },
            { title: 'Custom Fields', path: '/admin/work_area/settings/custom-fields', testid: 'settings-custom-fields-link' },
            {
                title: 'Billing',
                path: '/admin/work_area/settings/billing',
                condition: (ctx) => ctx.currentPlan !== 'Trial' && ctx.currentPlan !== 'Expired',
                testid: 'settings-billing-link'
            },
            { title: 'Global Watchlist Rules', path: '/admin/work_area/settings/global-watchlist', testid: 'settings-global-watchlist-link' }
        ]
    }
];
...
export const DELIVERY_MANAGER_MENU: SidebarItem[] = [
    ...
    },
    {
        title: 'Delivery Log',
        icon: Users,
        path: '/admin/work_area/delivery-manager/delivery-logs',
        condition: (ctx) => ctx.isDeliveryManagerEntitled,
    ...
    },
    {
        title: 'Receiving Log',
        icon: LogIn,
        path: '/admin/work_area/delivery-manager/receiving-logs',
        condition: (ctx) => ctx.isDeliveryManagerEntitled,
    ...
    },
    {
        title: 'Delivery Area',
        icon: Contact,
        path: '/admin/work_area/delivery-manager/delivery-area',
        condition: (ctx) => ctx.isDeliveryManagerEntitled,
