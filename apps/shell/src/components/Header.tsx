...
const Header = () => {
  ...
  return (
    <header className="tw:sticky tw:top-0 tw:z-50 tw:w-full tw:border-b tw:border-white/5 tw:bg-[#0b0f1a]/80 tw:backdrop-blur-xl">
    <div className="tw:container tw:mx-auto tw:flex tw:h-20 tw:items-center tw:justify-between tw:px-4 tw:sm:px-8">
      ...
      <nav className="tw:hidden tw:items-center tw:gap-10 tw:lg:flex">
      ...
      <div className="tw:flex tw:items-center tw:gap-5">
        ...
        <button className="tw:group tw:relative tw:flex tw:items-center tw:gap-2 tw:rounded-full tw:bg-white tw:px-6 tw:py-2.5 tw:text-sm tw:font-bold tw:text-black tw:transition-all hover:tw:bg-slate-100 active:tw:scale-95">
          Get Started
          <svg 
        ...
        {/* Mobile Toggle */}
        <button className="tw:flex tw:h-10 tw:w-10 tw:items-center tw:justify-center tw:rounded-lg tw:bg-slate-900 tw:text-white tw:lg:hidden">
