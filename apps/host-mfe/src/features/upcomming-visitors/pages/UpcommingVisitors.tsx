    ...
    <div className="tw:p-4 md:tw:p-6 tw:bg-gray-50 tw:min-h-screen tw:font-sans" data-test-id="upcoming-visitors-page">
      <div className="tw:w-full tw:mx-auto" data-test-id="upcoming-visitors-container">
        ...
        <div className="tw:bg-white tw:shadow-xl tw:border tw:border-gray-200 tw:overflow-hidden tw:p-4" data-test-id="upcoming-visitors-table-container">
          ...
          <div className="tw:flex tw:flex-col tw:sm:flex-row tw:md:flex-row tw:justify-between tw:items-center tw:gap-4" data-test-id="upcoming-visitors-table-header-controls">
            <div className="tw:flex justify-between tw:items-center tw:gap-4 tw:w-full tw:sm:w-auto" data-test-id="upcoming-visitors-search-section">
              <div className="tw:relative tw:w-full tw:sm:w-[30vw] tw:md:w-[30vw] tw:lg:w-[20vw] tw:w-[20vw]" data-test-id="upcoming-visitors-search-input-container">
                <Search
            ...
            <div className="tw:flex tw:items-center tw:gap-4 " data-test-id="upcoming-visitors-controls-section">
              ...
              <div className="tw:flex tw:items-center tw:gap-3 tw:text-sm tw:text-gray-600" data-test-id="upcoming-visitors-rows-per-page">
                ...
                >
                  {[10, 15, 20, 50, 100].map((size) => (
                    <option key={size} value={size} data-test-id={`upcoming-visitors-page-size-option-${size}`}>
                      {size}
                    </option>
                  ))}
                </select>
